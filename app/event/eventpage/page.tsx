  ...
  const onSubmit = async (data: FormData) => {
    try {
      const res = await fetch(
        "https://my-json-server.typicode.com/KANGJIYEON2/AIA_Spurs_project/events",
        {
          method: "POST",
            ...
            >
              <DialogContentText>
                <Typography variant="h6" sx={{ mb: 2 }}>
                  {" "}
                  이벤트 당첨시 경품 지급 안내를 위해 정확한 정보를 기입해
                  주세요.
                </Typography>
              </DialogContentText>
              <FormControlLabel
              ...
              <Typography variant="body2" sx={{ mt: 1 }}>
                AIA생명보험 주식회사가 이벤트 진행 등을 목적으로 아래와 같이
              ...
              >
                <Typography variant="body2">
                  <strong>수집·이용 목적: </strong>이벤트 진행 및 관련 업무 처리
                  (당첨자 선정, 안내, 경품 제공, 문의∙민원 처리 등) 이벤트
                  홈페이지 개발 및 운영·관리 등
                </Typography>
                <Typography variant="body2" sx={{ mt: 1 }}>
                  <strong>수집·이용 항목: </strong>이름, 휴대폰번호, 성별,
                  거주지역, 생년월일, 이벤트 관련 업무 처리에 필요한 정보 등
                </Typography>
                <Typography variant="body2" sx={{ mt: 1 }}>
              ...
              <Typography variant="body2" sx={{ mt: 2 }}>
                AIA생명보험 주식회사가 보험상품∙서비스 소개 및 홍보 등을
                목적으로 아래와 같이 본인의 개인정보를 수집·이용하는 것에
                동의합니다.
              </Typography>
              ...
              <Typography variant="body2" sx={{ mt: 2 }}>
                AIA생명보험 주식회사 및 회사의 업무 수탁자가 전화, 전자적 전송
                매체(문자, 이메일, 메신저, SNS 등) 등의 방법으로 회사의
                상품∙서비스 홍보나 판매 등의 광고성 정보를 전송하는 것에
                동의합니다.
              </Typography>

              <Typography variant="body2" sx={{ mt: 2 }}>
                ※ 위의 동의를 거부하실 수도 있습니다. 그러나 동의를 거부하면
                이벤트 참여나 경품 제공 등의 혜택을 받는 데 제한이 있을 수
                있습니다.
              </Typography>
            </Box>
